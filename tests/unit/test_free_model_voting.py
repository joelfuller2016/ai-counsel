...
'''
    ...
    def test_parse_vote_integer_confidence(self):
        ...
        response = '''VOTE: {"option": "Yes", "confidence": 1, "rationale": "Certain"}'''
...
class TestMalformedVotes:
    ...
    def test_malformed_invalid_json(self):
        ...
        response = '''VOTE: {"option": "Yes", "confidence": 0.8, rationale: "Missing quote"}'''
...
VOTE: {{"option": "Yes", "confidence": 0.8, "rationale": "Oops"'''
    ...
    def test_malformed_null_values(self):
        ...
        response = '''VOTE: {"option": null, "confidence": 0.8, "rationale": "Null option"}'''
...
class TestCostTracker:
    ...
    def test_cost_breakdown_by_model(self):
        ...
        assert report.cost_breakdown["opus@claude"] > report.cost_breakdown["sonnet@claude"]
